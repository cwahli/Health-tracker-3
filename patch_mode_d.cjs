...
const oldBlock = `MODE D: EVALUATION / COMPARISON
...
- NUTRITIONAL DOMINANCE LAW (CRITICAL): You MUST group items strictly by their clinical nutritional value, primary base ingredient, or risk profile (e.g., 'Potato-Based Chips (Highest Saturated Fat)', 'Corn & Tortilla Options', 'Cassava & Root Veggie Snacks'). You are strictly FORBIDDEN from creating groups named after physical layout locations like shelves, rows, or tables (e.g., Do NOT use 'Top Shelf Selections').
